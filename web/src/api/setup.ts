...
export const setupFeishuSave = (body: {
  ...
  platform_name?: string; owner_open_id?: string; work_dir?: string; agent_type?: string; agent_options?: Record<string, any>;
...
export const setupWeixinSave = (body: {
  ...
  platform_name?: string; ilink_bot_id?: string; ilink_user_id?: string; work_dir?: string; agent_type?: string; agent_options?: Record<string, any>;
